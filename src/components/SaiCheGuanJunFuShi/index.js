...
class SaiCheGuanJunFuShi extends React.PureComponent {
  ...
  remove(val) {
    ...
    const numbers = [...status] && [...status].sort() && [...status].sort(function(a, b) {return a-b }).join('-');
        ...
        <div className={styles.selectDetailCell}>
          <div>
            <div className={styles.selectDetailCellLeft}>
             {this.props.nameOne ? <div className={styles.selectDetailTitle}>{this.props.nameOne}</div> : <div />}
...
export default SaiCheGuanJunFuShi;
